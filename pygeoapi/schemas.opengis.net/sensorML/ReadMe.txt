...
2020-08-21  Eric Hirschorn
  * v2.1.0: SensorML 2.1.0 schema as sensorML/2.1 from OGC 12-000r2.
  * v2.1.0: Updated SensorML standard to support setEncodedValues.
  * v2.1.0: Example added showing use of new setEncodedValues.
		Contains 2 XML documents demonstrating use of setEncodedValues.
			a. sensor_instance.xml
				Makes use of the new setEncodedValues method for setting array values.
			b. sensor_model.xml
...
Copyright (c) 2007-2020 Open Geospatial Consortium.
