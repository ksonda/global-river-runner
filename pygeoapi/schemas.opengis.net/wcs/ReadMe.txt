...
2020-12-10  Gobe Hobona
  + v1.0: Update wcs/metoceanProfile/1.0/examples - Validated using Netbeans

2020-10-30  OGC MetOcean Domain Working Group
  + v1.0: Added MetOcean GetPolygon Extension for WCS2.1 1.0.0
          as wcs/metoceanProfile/1.0/wcsMetOceanGetPolygon.xsd
          from OGC documents 15-045r7, 15-108r3, and 17-086r3.

2020-10-27  OGC MetOcean Domain Working Group
  + v1.0: Added MetOcean Application Profile 1.0.0 as wcs/metoceanProfile/1.0
          from OGC documents 15-045r7, 15-108r3, and 17-086r2.

2020-08-28  Gobe Hobona
  * wcs/2.1: wcsAll.xsd Update Copyright and correct unused xmlns:wcs21 prefix
